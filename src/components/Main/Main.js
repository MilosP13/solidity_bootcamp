...
import ExpenseAnalysisModal from "../AnalyseExpense/ExpenseAnalysisModal.js"; // Import the new modal component
...
const Main = () => {
  ...
  const [showAnalysisModal, setShowAnalysisModal] = useState(false); // State to control the analysis modal visibility
  ...
  return (
    <div className="main-container">
      ...
      <button className="expense-analysis-button" onClick={() => setShowAnalysisModal(true)}>Expense Analysis</button> {/* New button for expense analysis */}
      ...
      {showAnalysisModal && ( // Display the expense analysis modal when showAnalysisModal is true
